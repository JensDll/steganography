  ...
  <div class="group relative">
    ...
    <button
      ...
      :class="[
        ...
        {
          default: `border-white border-opacity-90 bg-white bg-opacity-90 hover:border-gray-100 hover:bg-gray-100 focus:outline-gray-400
          dark:border-gray-800 dark:bg-gray-800 dark:hover:border-gray-600 dark:hover:bg-gray-600`,
